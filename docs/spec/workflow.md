...
|---|---|---|
| テストで示す | 決まった入力に決まった出力を返すコード | 先に失敗するテストを書いて、それが通るようになったこと |
| 作った物で示す | AI に読ませる文章、設定ファイル | 決めた内容のファイルが存在し、形式の検査を通り、人が読んで OK と言ったこと |
| 外で確かめる | 実機での動作確認、人が頼んだ実測 | 実行した結果を人が見て OK と言ったこと |
