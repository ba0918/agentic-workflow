...
- During ordinary dialogue, reply in chat and create or edit no files. Only save session progress after the human agrees to a semantic change; only write canonical documents during an approved wrap.
