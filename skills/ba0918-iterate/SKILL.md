...
(it starts from a request; an investigation starts from a symptom) with a self-contained prompt:
the request, the worktree path, the specification path if given, the four conditions verbatim,
